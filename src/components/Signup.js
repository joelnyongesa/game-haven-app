        ...
        <div className='flex flex-col items-center justify-center p-20'>
            ...
            <Formik
                ...
                onSubmit={({confirmPassword, e, ...values})=>{
                    ...
                    // })
                    // e.resetForm();
                    enqueueSnackbar("Thanks for trying out our platform!", {variant: 'success'})
                }}
            >
                {({errors, touched})=>(
                    <Form className='flex flex-col content-center justify-center max-w-xs w-full'>
                        ...
                        <Field type='text' name="username" id='username' className='text-rich-black px-2 py-1 rounded'/>
                        ...
                        <Field type='text' name="email" id='email' className='text-rich-black px-2 py-1 rounded'/>
                        {touched.email && errors.email && <div className='text-indian-red'>{errors.email}</div>}

                        <label className='m-2 font-bold' htmlFor='password'>
                            Password
                        </label>
                        <Field type='password' name='password' id='password' className='text-rich-black px-2 py-1 rounded' />
                        {touched.password && errors.password && <div className='text-indian-red'>{errors.password}</div>}

                        <label className='m-2 font-bold' htmlFor='password'>
                            Confirm Password
                        </label>
                        <Field type='password' name='confirmPassword' id='confirmPassword' className='text-rich-black px-2 py-1 rounded' />
